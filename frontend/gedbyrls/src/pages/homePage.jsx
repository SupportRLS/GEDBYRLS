    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] items-center justify-items-center px-6 ">
        <div className="text-center lg:text-left">
          ...
          <p className=" text-center sm:text-lg leading-relaxed">
            ...
            vos processus administratifs et assurez la conformité de vos
            données. Notre objectif : vous faire gagner du temps, réduire vos
            coûts et libérer vos équipes des tâches répétitives. Découvrez dès
      ...
      <div className="px-6 py-12 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <FeatureCard
            icon={<FaLock />}
            title="Sécurité renforcée des données"
          />
        </div>
      </div>
      <div className="sectionThreePage">
        ...
        <p>
          Centralisez l’ensemble de vos documents professionnels dans un espace
          sécurisé, accessible à tout moment et depuis n’importe où. Notre
          solution de Gestion Électronique de Documents vous permet de gagner un
          temps précieux en facilitant la recherche, la consultation et le
      ...
      <div className="SectionFivePage">
        <h2 className=" font-bold">Les principales fonctionnalités </h2>
        <div className="featureCards">
          <FeatureCard
            icon={<FaCloudUploadAlt />}
            title="Archivage électronique sécurisé"
          />
