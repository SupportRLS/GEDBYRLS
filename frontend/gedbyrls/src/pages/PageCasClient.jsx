...
function CasClients() {
  ...
  return (
    <>
      <Helmet>
        <title>Cas Client - RLS </title>
        <meta
          name="description"
          content=" Découvrez nos cas clients et témoignages pour voir comment Zeendoc optimise la gestion documentaire, améliore la productivité et assure la conformité dans divers secteurs d'activité."
        />
      </Helmet>
      <div className="min-h-screen flex flex-col">
        <Header />
                  ...
                  <div className="relative h-40  overflow-hidden">
                    {getImageUrl(casClient) ? (
                      <img
                        ...
                        alt={
                          casClient.image?.alternativeText || casClient.Titre
                        }
                      />
