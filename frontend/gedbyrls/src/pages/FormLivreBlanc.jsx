...
function FormLivreBlanc() {
  ...
  return (
    <>
      <Helmet>
        <title>Formulaire livre blanc - RLS </title>
        <meta
          name="description"
          content="Téléchargez nos livres blancs sur la gestion électronique de documents (GED) avec Zeendoc en remplissant notre formulaire. Obtenez des insights précieux pour optimiser l'archivage et la productivité de votre entreprise."
        />
      </Helmet>
      <div className="PageFormLivreBlanc">
        ...
        >
          ...
          <p className="text-xs text-gray-500 text-center mt-4">
            ...
            personnelles soient utilisées pour vous envoyer le livre blanc
            demandé et d'éventuelles communications liées à nos services.
          </p>
        </form>
        <Footer />
      </div>
