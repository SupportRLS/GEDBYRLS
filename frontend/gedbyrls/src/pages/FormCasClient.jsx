...
function FormCasClient() {
  ...
  return (
    <>
      <Helmet>
        <title>Formulaire cas client - RLS </title>
        <meta
          name="description"
          content="Remplissez notre formulaire pour recevoir un cas client détaillant comment Zeendoc a aidé une entreprise à optimiser sa gestion documentaire et améliorer sa productivité."
        />
      </Helmet>
