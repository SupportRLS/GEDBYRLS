  ...
  return (
    <div className="formationPage">
      ...
      <h1 className="font-bold">
        Formation ZeenDoc : Accompagner tous les professionnels dans la maîtrise
        de leur GED
      </h1>
      ...
      <div className="sectionOneText">
        ...
        <p>
          ...
          équipe, qui connaît les problématiques terrain et vous accompagne pas
          à pas, avec un langage clair et accessible.
        </p>
        <p className="poppins-medium-italic">
          “Notre objectif n’est pas de vous surcharger d’informations
          techniques, mais de vous permettre de tirer un vrai bénéfice métier de
          ZeenDoc, dès la première utilisation.”{" "}
        </p>
