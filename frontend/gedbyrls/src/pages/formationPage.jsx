...
<div className="formationPage">
  <Header />
  <h1>Formation ZeenDoc : Accompagner tous les professionnels dans la maîtrise de leur GED</h1>
 ...
 <div className="SectionOne">
  ...
  <p>Nos formations sont assurées par un expert ZeenDoc membre de notre équipe, qui connaît les problématiques terrain et vous accompagne pas à pas, avec un langage clair et accessible.</p>
  <p className="poppins-medium-italic">“Notre objectif n’est pas de vous surcharger d’informations techniques, mais de vous permettre de tirer un vrai bénéfice métier de ZeenDoc, dès la première utilisation.” </p>
  <p>— Rémy, formateur GED</p>
  </div>
 
  <div className="feature-cards ">
    <div className="lineOne">
    <FeatureCard icon={<FaShieldAlt />} title="Sécurité et confidentialité des données" />
    <FeatureCard icon={<FaSearch />} title="Accès rapide à l'information pertinente" />
    <FeatureCard icon={<FaFileAlt />} title="Archivage légal des documents" />
    </div>
    <div className="lineTwo">
    <FeatureCard icon={<FaClock />} title="Gain de temps sur les tâches administratives" />
    <FeatureCard icon={<FaUsers />} title="Gestion collaborative des dossiers" />
    </div>
  </div>
